...
products.map((el) => {
    ...
    <div class="product-item-img"><a href ="product.html"><img class="product-image" src="${el.image}"></a><img class="new-img" src="${el.new}"><i class="fa-regular fa-heart fa-2xl"></i></div>
